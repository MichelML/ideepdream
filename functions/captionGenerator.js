...
const tags = [
  ...
  "#tech #technology #techno #technologies #techie #techy #software #softwareengineer #softwareengineering #artificialintelligence #ai #ml #machinelearning #deeplearning #javascript #nodejs #python #api #deepdream #deep #engineer #engineers #engineering #arts #visualart #photography #visualarts #artificialintelligence #ai #ml #machinelearning #deeplearning",
...
//   ${randomItem(tags)}`;
// };
tags.forEach((h) => console.log(_.uniq(h.split(" ")).join(" ")));
